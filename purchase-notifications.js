// Bottles Bought
var stockNumber = 250;
const cNames = ['Michael', 'James', 'John', 'Robert', 'David', 'William', 'Christopher', 'Joseph', 'Richard', 'Daniel'];
...
<div id="purchase-notifications" class="purchases-disclaimer">
  <div class="purchases-box">
	<div class="purchased-bottle">
	  <img id="one-bottle" src="assets/img/img-2-bottles.webp" style="display: none;">
	  <img id="three-bottles" src="assets/img/img-3-bottles.webp" style="display: none;">
	  <img id="six-bottles" src="assets/img/img-6-bottles.webp" style="display: none;">
	</div>
